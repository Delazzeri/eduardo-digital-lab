...
const events = [
  ...
  { year: "2025", title: "Estrategista de Marketing", description: "Ao assumir o setor de marketing da empresa, fui responsável pela estruturação completa do departamento de Marketing, estabelecendo processos internos e diretrizes de marca, padronização da identidade visual e comunicação em redes sociais, aumentando a consistência da marca, gestão de fluxo de conteúdo, com foco em organização de postagens e cronograma editorial e gestão de fluxo de conteúdo, com foco em organização de postagens e cronograma editorial." },
